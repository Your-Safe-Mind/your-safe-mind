...
export default function About() {
  const pageTitle = "About Us | " + defaultMetadata.siteName;
  const pageDescription =
    "Learn about our experienced mental health professionals and our commitment to providing quality counseling services.";
  ...
  return (
    <>
        ...
        <meta property="og:url" content={`${defaultMetadata.siteUrl}/about`} />
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              ...
              psychotherapy services across the UK with compassion and
              expertise.
            </p>
          </div>
        </div>
            ...
            <div className="relative group transition-all duration-300 ease-in-out">
              ...
              <div className="relative px-6 py-8 bg-white rounded-xl leading-none">
                ...
                <p className="text-gray-700">
                  ...
                  prioritised and support is readily available to all who need
                  it.
                </p>
              </div>
            </div>
            ...
            <div className="relative group transition-all duration-300 ease-in-out">
              ...
              <div className="relative px-6 py-8 bg-white rounded-xl leading-none">
                ...
                <p className="text-gray-700">
                  ...
                  well-being, ensuring professional support is accessible and
                  effective.
                </p>
              </div>
            </div>
            ...
            <div className="relative px-8 py-10 bg-white rounded-xl text-center leading-none">
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  ...
                  professional ethics in accordance with UK healthcare
                  regulations and professional guidelines. Your privacy and
                  trust are paramount to our practice.
                </p>
                <p>
                  Our 24-hour cancellation policy ensures fair access to
                  services for all clients. We offer both in-person and online
                  sessions, providing flexible options to meet your needs.
                </p>
                <p>
                  We are registered with relevant UK professional bodies and
                  adhere to the ethical frameworks set by the British
